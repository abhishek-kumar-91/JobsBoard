...
function FooterDiv() {
  return (
    <div className='footer p-[5rem] mb-4 bg-[#2a68ff] rounded-[10px] gap-8 grid grid-cols-5 m-auto items-center justify-center '>
        <div>
        <div className='logoDiv'>
          <h1 className='logo text-[25px] text-white pb-[1.5rem] '><strong>Job</strong>Boards</h1>
        </div>
        ...
        <div className='grid'>
          ...
          <div>
            ...
            <div className='icons flex gap-4 py-[1rem]'>
                ...
                <AiOutlineTwitter className='bg-white p-[8px] h-[35px] w-[35px] rounded-full icon text-[#2a68ff]' />
            </div>
