...
function SearchDiv() {
  return (
    <div className='searchDiv grid gp-10 bg-[#f1f4f8] rounded-[10px] p-[3rem]'>
        <form action=''>
          <div 
          className='firstDiv flex justify-between items-center rounded-[8px] gap-[10px] bg-white p-5 shadow-lg shadow-[#f1f4f8] '>
            ...
            <div className='flex gap-2 items-center'>
                ...
                <input type='text' className='bg-transparent text-blue-500 focus:outline-none w-[100%] ' placeholder='Search By Companies....' />
                <AiOutlineCloseCircle className='text-[30px]  text-[#a5a6a6] hover:text-[#252b36] icon' />
            </div>
        ...
        <div className='secDiv flex items-center gap-10 justify-center mt-8'>
